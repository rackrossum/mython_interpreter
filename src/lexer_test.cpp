...
no_indent)");
    ...
    Lexer lexer(input);
    ASSERT_EQUAL(lexer.CurrentToken(), Token(TokenType::Indent{}));
    ASSERT_EQUAL(lexer.NextToken(), Token(TokenType::Indent{}));
    ASSERT_EQUAL(lexer.NextToken(), Token(TokenType::Id{"indent"}));
    ASSERT_EQUAL(lexer.NextToken(), Token(TokenType::Newline{}));
...
no_indent
  ...
  ASSERT_EQUAL(lexer.CurrentToken(), Token(TokenType::Id{"no_indent1"}));
  ASSERT_EQUAL(lexer.NextToken(), Token(TokenType::Newline{}));
  ASSERT_EQUAL(lexer.NextToken(), Token(TokenType::Indent{}));
...
void RunLexerTests(TestRunner& tr) {
  ...
  RUN_TEST(tr, Parse::TestIndentsSimple);
